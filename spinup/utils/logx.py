...
class EpochLogger(Logger):
    ...
    def save_log(self, key):
        """
        Save the log associated with the key to a npy file.
        """
        if key in self.episode_dict:
            ...
            np.save(osp.join(self.output_dir, f"{key}.npy"), vals)
            print(f"{key} saved to npy file.")
