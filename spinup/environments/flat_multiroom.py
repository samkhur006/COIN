...
class FlatMultiRoomEnv(FlatMiniGridEnv):
    """
    Environment with multiple rooms (subgoals) with flattened images.
    """
    ...
    def __init__(self, minNumRooms, maxNumRooms, maxRoomSize=10):
        ...
        super(FlatMultiRoomEnv, self).__init__(
...
class FlatMultiRoomEnvN2S4(FlatMultiRoomEnv):
    def __init__(self):
...
class FlatMultiRoomEnvN6(FlatMultiRoomEnv):
    def __init__(self):
