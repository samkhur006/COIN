"""
Credits: https://github.com/AGiannoutsos/car_racer_gym/blob/main/car_racing.py
"""
...
class CarRacingDiscrete(gym.Env, EzPickle):
    ...
    def __init__(self, total_episode_steps=1000, verbose=1):
        ...
        # )
        self.observation_space = spaces.Box(
            low=0, high=1, shape=(STATE_W, STATE_H, 1), dtype=np.float16
        )
