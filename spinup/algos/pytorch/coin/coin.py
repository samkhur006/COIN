...
class ReplayBuffer:
    ...
    def store(self, obs, act, rew, coin_rew, next_obs, done):
        """
...
def coin(
    ...
    Args:
        ...
        polyak (float): Interpolation factor in polyak averaging for target
            networks. Target networks are updated towards main networks/home/guest123/SPRING/spinning-coin/data/coin_td3_lunar_lander_try/coin_td3_lunar_lander_try_s0
            according to:
    ...
    for t in range(total_steps):
        ...
        if d or (ep_len == max_ep_len):
            ...
            if n_episodes%500 ==0:
                o, ep_ret, ep_len = env.reset(b=True), 0, 0
                cum_bonus += bonus
                print("------------------ NEW ENVIRONMENT ----------  BONUS ADDED  ---------------")
            ...
            if n_episodes % log_freq == 0:
                ...
                logger.log_tabular("Current bonus", cum_bonus)
